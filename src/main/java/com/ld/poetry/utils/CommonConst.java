...
public class CommonConst {
     ...
     * 七牛云
     */
    public static final String ACCESS_KEY = "Jffx4Fw1TpIVLxXorL0aDqTxRGf6nNnVuZ2qn1fM";

    public static final String SECRET_KEY = "4TKKVusBhX-6jjsyZUBKqxDRRnApCgscg3xZXXgy";

    public static final String BUCKET = "test0923z";

    public static final String DOWNLOAD_URL = "https://cdn.ldx0923.asia/";
